...
const getAllElectronics = async(req,res) =>{
    try{
        const electronics = await Product.find({catagory : "electronics",sold: false});
        return res.status(200).json({
            electronics
        })
    }catch(error){
...
const getAllBooks = async(req,res) =>{
    try{
        const books = await Product.find({catagory : "books",sold: false});
        return res.status(200).json({
            books
        })
    }catch(error){
...
const getAllAppliences = async(req,res) =>{
    try{
        const appliences = await Product.find({catagory : "appliances",sold: false});
        return res.status(200).json({
            appliences
        })
    }catch(error){
...
const getAllEngineering = async(req,res) =>{
    try{
        const engineering = await Product.find({catagory : "engineering",sold: false});
        return res.status(200).json({
            engineering
        })
    }catch(error){
...
const getAllFurniture = async(req,res) =>{
    try{
        const furniture = await Product.find({catagory : "furnature",sold: false});
        return res.status(200).json({
            furniture
        })
    }catch(error){
